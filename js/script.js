/**
 * Restaurant Management - Core UI Scripts
...
function initPageAnimations() {
  ...
  if (document.querySelector('.auth-page')) {
    ...
    // We only animate the decorative floating elements (foods and ambient shape blobs) with GSAP
    gsap.killTweensOf('.floating-food, .shape-blob');
    
    gsap.fromTo('.floating-food', { opacity: 0, scale: 0 }, {
